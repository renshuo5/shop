...
<!--top-->
    <div class="top-wrapper">
        <div class="top-info">
            <div class="top-left">
                <div data-toggle="arrowdown" id="arrow1" class="user-name">
                    <a href="http://sucai.aspku.com">素材库</a>
                ...
                <img height="34px" a-float-left src="${rc.contextPath}/s/img/qqq.gif" />
                <!--hidden-box-->
                <div data-toggle="hidden-box" id="nav-box1" class="user-box">
                    <img class="my-head" src="${rc.contextPath}/s/img/user-head.jpg" />
                    <div class="my-grow">
                    ...
                    <div class="my-card">
                        <div class="cards-info">
                            <ul>
                                <li><img src="${rc.contextPath}/s/img/icon.png" /></li>
                                <li><img src="${rc.contextPath}/s/img/icon.png" /></li>
                            </ul>
                        </div>
                ...
                <div data-toggle="hidden-box" id="nav-box2" class="msg-box">
                    ...
                    <div class="read-info">
                        ...
                        <img src="${rc.contextPath}/s/img/book-1.png" />
        ...
        <div class="scroll-search">
            <div class="search-litter">
                <img class="scroll-logo" src="${rc.contextPath}/s/img/logo.png" />
                <!--scroll-search-->
    ...
    <!--top-main-->
    <div class="top-main">
        <img src="${rc.contextPath}/s/img/logo.gif" />
        ...
        <div class="two-code">
            <h3>手机淘宝</h3>
            <img src="${rc.contextPath}/s/img/code.png" />
