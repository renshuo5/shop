				...
				<div class="contents clearfix">
					<ul class="clearfix">
						...
						<li class="clearfix">
							...
							<div class="goods_pic"><span class="goods_price">¥ 279.00 </span><a href=""><img src="${rc.contextPath}/s/images/89a6d6466b00ae32d3c826b9ec639084.jpg_small.jpg" /></a></div>
		...
		<div class="shop_bd_list_right clearfix">
			...
			<div class="shop_bd_list_content clearfix">
				<ul>
					...
					<li>
						<dl>
							<dt><a href=""><img src="${rc.contextPath}/s/images/21151da3bdefc6d9a7120c991fe59800.jpg_small.jpg" /></a></dt>
							<dd class="title"><a href="${rc.contextPath}/product/detail/${em.id}">${em.name}</a></dd>
							<dd class="content">
								<span class="goods_jiage">￥<strong>${em.price}</strong></span>
